...
# the code was taken from https://github.com/ternaus/TernausNet
...
class AlbuNet(nn.Module):
    ...
    def __init__(self, num_classes=1, num_filters=32, pretrained=False, is_deconv=False, freeze_encoder=False):
        ...
        #print(self.encoder.conv1
        first_layer = nn.Conv2d(4, 64, kernel_size=(7, 7), stride=(2, 2), padding=(3, 3), bias=False)
     #   self.first_layer = nn.Conv2d(4, 3, kernel_size=(1, 1), stride=(1, 1), bias=False)
        self.conv1 = nn.Sequential(first_layer,
                                   self.encoder.bn1,
                                   self.encoder.relu,
                                   self.pool)
